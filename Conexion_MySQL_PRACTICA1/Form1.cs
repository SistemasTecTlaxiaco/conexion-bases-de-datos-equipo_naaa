    ...
    public partial class Conexion_BaseDatos : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // Si se abre correctamente, se muestra mensaje en la interfaz
                label1.Text = "Conexión Exitosa";
            }
            catch (Exception error) // Si ocurre un error, se captura aquí
            {
                // Se muestra un mensaje de error junto con la descripción del problema
                label1.Text = "Error de conexión: " + error.Message;
            }
